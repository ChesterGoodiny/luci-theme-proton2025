...
window.ProtonTranslations = {
  ru: {
    ...
    "Choose light, dark, or system theme": "Выберите тему или следуйте системным настройкам",
  ...
  zh: {
    ...
    "Choose light, dark, or system theme": "选择主题或跟随系统设置",
    "Accent Color": "强调色",
  ...
  de: {
    ...
    "Choose light, dark, or system theme": "Theme wählen oder Systemeinstellung folgen",
  ...
  uk: {
    ...
    "Choose light, dark, or system theme": "Оберіть тему або слідуйте системним налаштуванням",
  ...
  es: {
    ...
    "Choose light, dark, or system theme": "Elegir tema o seguir configuración del sistema",
  ...
  pt: {
    ...
    "Choose light, dark, or system theme": "Escolher tema ou seguir configuração do sistema",
  ...
  pl: {
    ...
    "Choose light, dark, or system theme": "Wybierz motyw lub dostosuj do ustawień systemowych",
  ...
  fr: {
    ...
    "Choose light, dark, or system theme": "Choisir le thème ou suivre le réglage du système",
  ...
  it: {
    ...
    "Choose light, dark, or system theme": "Scegli tema o segui le impostazioni di sistema",
